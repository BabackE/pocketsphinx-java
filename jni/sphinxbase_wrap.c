...
SWIGEXPORT jint JNICALL Java_edu_cmu_pocketsphinx_SphinxBaseJNI_NGramModel_1prob(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jlong jarg3) {
  jint jresult = 0 ;
  NGramModel *arg1 = (NGramModel *) 0 ;
  size_t arg2 ;
  char **arg3 = (char **) 0 ;
